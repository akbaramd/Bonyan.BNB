...
public static class ServiceCollectionRegistrationActionExtensions
{
    ...
    public static void DisableBnbClassInterceptors(this IServiceCollection services)
    {
        GetOrCreateRegistrationActionList(services).IsClassInterceptorsDisabled = true;
    }

    public static bool IsBnbClassInterceptorsDisabled(this IServiceCollection services)
    {
